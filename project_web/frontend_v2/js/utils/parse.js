        ...
        const evaluate = (expr) => {
            ...
            try {
                ...
                e = e.replace(/\bpi\b/g, "Math.PI")
                     ...
                     .replace(/\bsin\b/g, isRadianContext ? "Math.sin" : "((x)=>Math.sin(x*Math.PI/180))")
                     .replace(/\bcos\b/g, isRadianContext ? "Math.cos" : "((x)=>Math.cos(x*Math.PI/180))")
                     .replace(/\btan\b/g, isRadianContext ? "Math.tan" : "((x)=>Math.tan(x*Math.PI/180))");
                ...
                const mathScope = {
                    ...
                    // Trigono thông minh
                    sin: (x) => isRadianContext ? Math.sin(x) : Math.sin(x * Math.PI / 180),
                    cos: (x) => isRadianContext ? Math.cos(x) : Math.cos(x * Math.PI / 180),
                    tan: (x) => isRadianContext ? Math.tan(x) : Math.tan(x * Math.PI / 180),
                    cot: (x) => isRadianContext ? 1/Math.tan(x) : 1/Math.tan(x * Math.PI / 180),
                };
