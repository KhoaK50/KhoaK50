 ...
 */
function setupGuidedTour(buttonId, tourSteps, onEndCallback) { // Thêm tham số onEndCallback
    const initTour = () => {
        ...
        if (typeof driverFn !== 'function') {
            ...
            btnTour.onclick = () => alert("⚠️ Thư viện hướng dẫn chưa tải xong, vui lòng chờ 1s hoặc nhấn Ctrl+F5!");
            return;
        }
