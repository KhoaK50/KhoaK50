...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (btnTour) {
        btnTour.addEventListener('click', () => isTourRunning = true, { capture: true });
    }
});
...
const khoiTaoVectorSteps = [
    ...
    },
    {
        ...
        onHighlighted: () => {
            ...
            clearTourTimeouts(); lockTour('Đang di chuyển...');
            forceScrollToTop(); 
    ...
    },
    {
        ...
        onHighlighted: () => {
            ...
            clearTourTimeouts(); lockTour('Đang click...'); 
            forceScrollToTop(); 
    ...
    },
    {
        ...
        onHighlighted: () => {
            ...
            clearTourTimeouts(); lockTour('Đang nhập liệu...'); 
            forceScrollToTop(); 
    ...
    },
    {
        ...
        onHighlighted: () => {
            ...
            tourSetTimeout(() => moveCursorTo('#btnClearAll', () => clickCursor(document.getElementById('btnClearAll'), unlockTour)), 100);
        }
    }
];
